...
import controller.menu.commande.CommandeReinitialiserAttribut;
...
public class MenuEditionFiche extends Menu {
	...
	private void initialiser() {
		...
		ajouter("Réinitialiser les attributs la fiche", new CommandeReinitialiserAttribut(fiche));
		Iterator<Categorie> iterateur = fiche.iteratorCategories();
		Categorie categorie;
		while (iterateur.hasNext()) {
			categorie = iterateur.next();
			ajouter(categorie.getType(), new MenuEditionCategorie("Modifier la catégorie", this.scenario, categorie, this.fiche));
		}
	}
